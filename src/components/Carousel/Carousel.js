...
import DomainContent from '../Domain/DomainContent'
import '../Domain/carouselStyle.css'
                  ...
                  <div className="slider-content">
                      {slides.map((slider, index) => (
                                <div className={slider.class} key={index}>
                                  <div className={sliderClass('left')} onClick={()=>{slideLeft();setIndex(index - 1)}}>
                                    ...
                                    <div className="text slider-single-content">
        {content.map((x, xIndex) => {
          return <DomainContent key={x.id} {...x} xIndex={xIndex} index={index} />
        })}
        </div>
